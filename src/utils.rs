...
pub fn get_mint(
    ...
    if
        dapp_address.eq("MoonCVVNZFSYkqNXP6bxHLPL6QQJiMagDL3qcqUQTrG") ||
        ...
        inner_instruction.instructions
            ...
            .for_each(|(inner_idx, inner_inst)| {
                ...
                if inner_program.as_str().eq("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA") {
                    ...
                    match discriminator {
                        3 => {
                            let input_accounts = prepare_input_accounts(
                                &inner_inst.accounts,
                                accounts
                            );
                            ...
                            if fee_account.clone().is_some_and(|x| x.clone().eq(&destination)) {
                                return;
                            }
