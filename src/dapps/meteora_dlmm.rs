...
const SWAP_WITH_PRICE_IMPACT_DISCRIMINATOR: u64 = u64::from_le_bytes([
...
const SWAP_EXACT_OUT2_DISCRIMINATOR: u64 = u64::from_le_bytes([
    43, 215, 247, 132, 137, 60, 243, 81,
]);
const SWAP_WITH_PRICE_IMPACT2_DISCRIMINATOR: u64 = u64::from_le_bytes([
